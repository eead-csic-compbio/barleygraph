...
$graphs{'Pan20-mmap-pro'}{'md5sum'} = 'f72aa40839a4f2267861565a1c59efce';
...
$graphs{'Pan20-gmap-geno'}{'md5sum'} = '3ec31754e06bb023a1cfa353a40dedaf';
...
if(defined($opts{'G'})) {
  ...
  # download graph samplelist file
